package com.infralabs.agent.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "alphaagent@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "alphaagent API";

        private String description = "alphaagent API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "alphaagent";
